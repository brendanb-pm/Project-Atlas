...
function model(state) {
  ...
  return {
    selectedId: id,
    results: [{ id, description: '1/2 in carbide end mill', condition: fixture.condition, location: fixture.holder ? 'Haas VF-4 / T12' : 'Tool crib A-14', nominalDiameter: 0.5, actualMeasuredDiameter: fixture.actual, unitSystem: 'INCH' }, { id: 'TOOL-aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', description: '1/4 in carbide end mill', condition: 'USED', location: 'Tool crib B-03', nominalDiameter: 0.25, actualMeasuredDiameter: null, unitSystem: 'INCH' }],
