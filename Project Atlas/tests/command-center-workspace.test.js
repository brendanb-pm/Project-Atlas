...
assert.match(index,/Attention and exceptions/);
...
assert.match(index,/state\.active==='CommandCenter'\)refreshWorkspace\(\)/,'Mission Control no longer loads bootstrap on entry');
