...
const context=vm.createContext({Date,Number,String,Object,Array,JSON,VmosConfigurationError_:function(m){this.message=m}});
...
const repository=new context.CalendarSyncEventRepository_(backing);
...
assert.ok(ui.includes('syncEvents:new CalendarSyncEventRepository_()'),'production reconciliation uses durable sync events');
