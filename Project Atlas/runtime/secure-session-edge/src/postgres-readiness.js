...
const DOMAIN_TABLES = Object.freeze(['atlas_users', 'atlas_tenant_memberships', 'atlas_external_identities', 'atlas_security_audit_events', 'atlas_customers', 'atlas_contacts', 'atlas_rfqs', 'atlas_quotes', 'atlas_quote_revisions', 'atlas_quote_lines', 'atlas_jobs', 'atlas_job_operations', 'atlas_job_events', 'atlas_job_qr_tokens', 'atlas_vendors', 'atlas_purchase_requests', 'atlas_purchase_approvals', 'atlas_invoices', 'atlas_cash_receipts', 'atlas_sales_activities', 'atlas_follow_ups', 'atlas_crm_activity_events', 'atlas_leads', 'atlas_lead_events', 'atlas_serialized_firearms', 'atlas_firearm_regulatory_events', 'atlas_tool_types', 'atlas_tool_instances', 'atlas_tool_measurements', 'atlas_tool_condition_events', 'atlas_holders', 'atlas_tool_assemblies', 'atlas_tool_machine_assignments', 'atlas_operation_tool_requirements', 'atlas_operation_tool_executions', 'atlas_tool_identifiers', 'atlas_wip_bins', 'atlas_wip_bin_assignments', 'atlas_wip_bin_location_events', 'atlas_wip_bin_identifiers', 'atlas_contextual_attachments', 'atlas_contextual_attachment_events', 'atlas_tool_manual_entry_events', 'atlas_ai_processing_jobs', 'atlas_ai_processing_results', 'atlas_ai_field_proposals', 'atlas_ai_processing_events', 'atlas_ai_review_sessions', 'atlas_ai_field_reviews', 'atlas_ai_review_events']);
