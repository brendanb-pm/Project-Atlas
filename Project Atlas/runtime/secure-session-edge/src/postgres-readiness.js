...
const DOMAIN_TABLES = Object.freeze(['atlas_users', 'atlas_tenant_memberships', 'atlas_external_identities', 'atlas_security_audit_events', 'atlas_customers', 'atlas_contacts', 'atlas_rfqs', 'atlas_quotes', 'atlas_quote_revisions', 'atlas_quote_lines', 'atlas_jobs', 'atlas_job_operations', 'atlas_job_events', 'atlas_job_qr_tokens', 'atlas_vendors', 'atlas_purchase_requests', 'atlas_purchase_approvals', 'atlas_invoices', 'atlas_cash_receipts', 'atlas_sales_activities', 'atlas_follow_ups', 'atlas_serialized_firearms', 'atlas_firearm_regulatory_events']);
