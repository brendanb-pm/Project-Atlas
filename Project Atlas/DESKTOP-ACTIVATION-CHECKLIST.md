...
| ExternalChangeRequests | `ExternalChangeRequestID`; `FollowUpID` | `ExternalChangeRequestID, Provider, FollowUpID, External Event ID, Change Type, Requested Due At, Requested Start At, Requested End At, Requested Time Zone, External Version, Status, Details, Detected At, Resolved At, Resolved By, Resolution` | External deletion/conflict review; never auto-deletes MOS follow-up |
