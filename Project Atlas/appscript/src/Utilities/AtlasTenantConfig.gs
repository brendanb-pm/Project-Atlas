...
var ATLAS_DEMO_TENANTS = {
  VMOS: {
    ...
    featureFlags: { nativeKanban: false, firearmsTablet: false, rfqIntake: false, salesActivities: false }, appearance: 'dark', workflow: ['RECEIVED', 'QUEUED', 'IN_PROCESS', 'COATING', 'FINAL_QC', 'READY', 'COMPLETE'], configurationRequired: []
  },
  IPM: {
    ...
    featureFlags: { nativeKanban: false, firearmsTablet: false, rfqIntake: false, salesActivities: false }, appearance: 'light', workflow: ATLAS_GENERIC_MANUFACTURING_WORKFLOW,
