...
Object.keys(VMOS_DEFAULT_MAPPING).forEach(function(entity){var fields=VMOS_DEFAULT_MAPPING[entity].fields;fields.securityOperationId=['Security Operation ID'];fields.securityOperationFingerprint=['Security Operation Fingerprint'];fields.securityTenantId=['Security Tenant ID'];fields.securityActorId=['Security Actor ID'];});
...
function getVmosConfig_() {
  ...
  Object.keys(mapping).forEach(function(entity){var fields=mapping[entity].fields||{};fields.securityOperationId=fields.securityOperationId||['Security Operation ID'];fields.securityOperationFingerprint=fields.securityOperationFingerprint||['Security Operation Fingerprint'];fields.securityTenantId=fields.securityTenantId||['Security Tenant ID'];fields.securityActorId=fields.securityActorId||['Security Actor ID'];mapping[entity].fields=fields;});
