...
function atlasRouteTemplate_(route){return {home:'Index',customers:'CommercialWorkflow',rfqs:'CommercialWorkflow',quotes:'CommercialWorkflow',jobs:'CommercialWorkflow',invoices:'CommercialWorkflow',purchasing:'PurchasingWorkspace','sales-activity':'SalesActivity','follow-ups':'CalendarFollowUps','shop-floor':'ShopFloor','operations-dashboard':'OperationsDashboard','floor-board':'FloorBoard',ideas:'Ideas',admin:'AdminSettings','platform-commercial':'PlatformCommercial',traveler:'Traveler'}[normalizeAtlasRoute_(route)]||'Index';}
