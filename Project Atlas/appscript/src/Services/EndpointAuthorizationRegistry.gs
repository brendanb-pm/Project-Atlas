...
var ATLAS_CALLABLE_ENDPOINTS = {
  ...
  searchVendors:{kind:'READ',capability:'QUOTE_COST_READ'}, getVendorWorkspace:{kind:'READ',capability:'QUOTE_COST_READ'}, createVendor:{kind:'WRITE',capability:'QUOTE_COST_WRITE'}, getQuoteBuilderWorkspace:{kind:'READ',capability:'QUOTE_WRITE'}, searchQuoteBuilderRecords:{kind:'READ',capability:'QUOTE_WRITE'}, saveQuoteCostEstimate:{kind:'WRITE',capability:'QUOTE_COST_WRITE'},
