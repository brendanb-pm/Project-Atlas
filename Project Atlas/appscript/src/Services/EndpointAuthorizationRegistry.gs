...
var ATLAS_MUTATION_RECOVERY = {
  ...
  createVendor:'PREALLOCATED_RESOURCE_ID',addQuoteSourceDocumentLink:'PREALLOCATED_RESOURCE_ID',removeQuoteSourceDocumentLink:'EXPLICIT_REVIEW',saveQuoteCostEstimate:'PREALLOCATED_RESOURCE_ID',
