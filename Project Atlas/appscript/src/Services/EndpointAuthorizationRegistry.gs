...
var ATLAS_CALLABLE_ENDPOINTS = {
  ...
  getCommercialWorkflowWorkspace:{kind:'READ',capability:'DYNAMIC_MVP'}, createContextualRfq:{kind:'WRITE',capability:'RFQ_WRITE'}, createQuoteFromRfq:{kind:'WRITE',capability:'QUOTE_WRITE'}, acceptQuote:{kind:'HIGH_RISK_WRITE',capability:'QUOTE_APPROVE'}, convertQuoteToJob:{kind:'HIGH_RISK_WRITE',capability:'OPERATIONS_WRITE'}, createInvoiceFromJob:{kind:'HIGH_RISK_WRITE',capability:'FINANCE_WRITE'},
