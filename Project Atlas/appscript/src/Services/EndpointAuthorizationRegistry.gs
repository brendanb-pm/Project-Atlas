...
var ATLAS_CALLABLE_ENDPOINTS = {
  ...
  searchVendors:{kind:'READ',capability:'QUOTE_COST_READ'}, getVendorWorkspace:{kind:'READ',capability:'QUOTE_COST_READ'}, createVendor:{kind:'WRITE',capability:'QUOTE_COST_WRITE'}, saveQuoteCostEstimate:{kind:'WRITE',capability:'QUOTE_COST_WRITE'},
...
var ATLAS_MUTATION_RECOVERY = {
  ...
  createVendor:'PREALLOCATED_RESOURCE_ID',saveQuoteCostEstimate:'PREALLOCATED_RESOURCE_ID',
