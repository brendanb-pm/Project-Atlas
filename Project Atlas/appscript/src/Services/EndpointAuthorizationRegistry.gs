...
var ATLAS_CALLABLE_ENDPOINTS = {
  ...
  getCommercialWorkflowWorkspace:{kind:'READ',capability:'DYNAMIC_MVP'}, getInternalJobCreationOptions:{kind:'READ',capability:'OPERATIONS_READ'}, createInternalJob:{kind:'HIGH_RISK_WRITE',capability:'OPERATIONS_WRITE'}, createShopAsset:{kind:'WRITE',capability:'OPERATIONS_WRITE'}, updateShopAsset:{kind:'WRITE',capability:'OPERATIONS_WRITE'}, archiveShopAsset:{kind:'HIGH_RISK_WRITE',capability:'OPERATIONS_WRITE'}, createContextualRfq:{kind:'WRITE',capability:'RFQ_WRITE'}, createQuoteFromRfq:{kind:'WRITE',capability:'QUOTE_WRITE'}, acceptQuote:{kind:'HIGH_RISK_WRITE',capability:'QUOTE_APPROVE'}, convertQuoteToJob:{kind:'HIGH_RISK_WRITE',capability:'OPERATIONS_WRITE'}, createInvoiceFromJob:{kind:'HIGH_RISK_WRITE',capability:'FINANCE_WRITE'}, recordInvoicePayment:{kind:'HIGH_RISK_WRITE',capability:'FINANCE_WRITE'}, reconcileInvoicePaymentAttempt:{kind:'READ',capability:'FINANCE_WRITE'}, getPurchasingWorkspace:{kind:'READ',capability:'PURCHASE_REQUEST'}, searchPurchasingVendors:{kind:'READ',capability:'PURCHASE_REQUEST'}, associatePurchaseRequestVendor:{kind:'HIGH_RISK_WRITE',capability:'PURCHASE_REQUEST'},
...
var ATLAS_MUTATION_RECOVERY = {
  ...
  createInternalJob:'PREALLOCATED_RESOURCE_ID',createShopAsset:'PREALLOCATED_RESOURCE_ID',updateShopAsset:'EXPLICIT_REVIEW',archiveShopAsset:'EXPLICIT_REVIEW',
