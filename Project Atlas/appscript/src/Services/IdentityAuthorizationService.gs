var ATLAS_CAPABILITIES = {
  ...
  CALENDAR_RECONCILE:'CALENDAR_RECONCILE', QUOTE_COST_READ:'QUOTE_COST_READ', QUOTE_COST_WRITE:'QUOTE_COST_WRITE', QUOTE_PRICING_MANAGE:'QUOTE_PRICING_MANAGE', QUOTE_MARGIN_READ:'QUOTE_MARGIN_READ', SECURITY_RECOVER:'SECURITY_RECOVER', FIREARMS_READ:'FIREARMS_READ', FIREARMS_WRITE:'FIREARMS_WRITE', FIREARMS_CUSTODY:'FIREARMS_CUSTODY', FIREARMS_DISPOSE:'FIREARMS_DISPOSE', FIREARMS_CORRECT:'FIREARMS_CORRECT', FIREARMS_RECONCILE:'FIREARMS_RECONCILE', ADMIN_CONFIG:'ADMIN_CONFIG', ADMIN_IDENTITY:'ADMIN_IDENTITY'
};
var ATLAS_DEFAULT_ROLE_CAPABILITIES = {
  SHOP_OPERATOR:['CORE_RECORD_READ','OPERATIONS_READ','SHOP_FLOOR_OPERATE','FIREARMS_READ','FIREARMS_CUSTODY'],
  ...
  MANAGER:['CORE_RECORD_READ','CORE_RECORD_WRITE','SALES_READ','SALES_WRITE','FOLLOWUP_READ','FOLLOWUP_WRITE','FOLLOWUP_REASSIGN','OPERATIONS_READ','OPERATIONS_WRITE','SHOP_FLOOR_OPERATE','RFQ_READ','RFQ_WRITE','QUOTE_WRITE','QUOTE_APPROVE','QUOTE_ISSUE','QUOTE_COST_READ','QUOTE_COST_WRITE','QUOTE_PRICING_MANAGE','QUOTE_MARGIN_READ','PURCHASE_REQUEST','PURCHASE_APPROVE','FINANCE_READ','CALENDAR_USE','CALENDAR_RECONCILE','FIREARMS_READ','FIREARMS_WRITE','FIREARMS_CUSTODY','FIREARMS_DISPOSE','FIREARMS_CORRECT','FIREARMS_RECONCILE'],
