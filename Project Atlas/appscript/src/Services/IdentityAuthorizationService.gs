...
SecurityAuditService_.prototype.executionContext_=function(context,record,options){var values={};Object.keys(context).forEach(function(key){values[key]=context[key];});values.checkpoint=function(result,recoveryContext){return this.checkpoint(record,result,options,recoveryContext);}.bind(this);return Object.freeze(values);};
