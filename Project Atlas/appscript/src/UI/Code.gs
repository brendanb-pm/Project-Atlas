...
function getSalesActivityMetrics() { try { return { ok: true, data: createSalesActivityService_().metrics(new Date()) }; } catch (error) { return toClientError_(error); } }
function createFollowUp(input) { try { return { ok: true, data: createFollowUpService_().create(input, getVmosAuditUser_()) }; } catch (error) { return toClientError_(error); } }
function rescheduleFollowUp(id, dueAt, expectedVersion) { try { return { ok: true, data: createFollowUpService_().reschedule(id, dueAt, expectedVersion, getVmosAuditUser_(), Utilities.getUuid()) }; } catch (error) { return toClientError_(error); } }
function scheduleFollowUp(id, schedule, expectedVersion) { try { return { ok: true, data: createFollowUpService_().schedule(id, schedule, expectedVersion, getVmosAuditUser_(), Utilities.getUuid()) }; } catch (error) { return toClientError_(error); } }
function completeFollowUp(id, expectedVersion) { try { return { ok: true, data: createFollowUpService_().complete(id, expectedVersion, getVmosAuditUser_(), Utilities.getUuid()) }; } catch (error) { return toClientError_(error); } }
function cancelFollowUp(id, expectedVersion) { try { return { ok: true, data: createFollowUpService_().cancel(id, expectedVersion, getVmosAuditUser_(), Utilities.getUuid()) }; } catch (error) { return toClientError_(error); } }
